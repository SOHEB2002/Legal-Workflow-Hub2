...
function mapDbCase(dbCase: any): LawCase {
  return {
    ...
    archivedAt: dbCase.archivedAt ? toISOString(dbCase.archivedAt) : null,
...
function mapDbNotification(dbNotif: any): Notification {
  return {
    ...
    isAutomatic: dbNotif.isAutomatic ?? false,
    relatedStage: dbNotif.relatedStage || null,
    workflowTriggerId: dbNotif.workflowTriggerId || null,
...
function mapDbMemo(dbMemo: any): Memo {
  return {
    ...
    startedAt: dbMemo.startedAt ? toISOString(dbMemo.startedAt) : null,
    completedAt: dbMemo.completedAt ? toISOString(dbMemo.completedAt) : null,
    submittedAt: dbMemo.submittedAt ? toISOString(dbMemo.submittedAt) : null,
    content: dbMemo.content || "",
    fileLink: dbMemo.fileLink || "",
    reviewNotes: dbMemo.reviewNotes || "",
    reviewerId: dbMemo.reviewerId || null,
    reviewedAt: dbMemo.reviewedAt ? toISOString(dbMemo.reviewedAt) : null,
...
export class DatabaseStorage implements IStorage {
  ...
  async getAllMemos(): Promise<Memo[]> {
    ...
    return result.map(mapDbMemo).sort(
