    ...
    topics: [
      {
        ...
        answer: "تمر القضية بعدة مراحل: استلام، استكمال المرفقات والبيانات، دراسة، تحرير صحيفة الدعوى، لجنة المراجعة، الأخذ بالملاحظات، جاهزة للرفع، قيد التدقيق، مداولة الصلح، أغلق طلب الصلح، ومقفلة.",
      },
      {
