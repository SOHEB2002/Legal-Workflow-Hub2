...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      dir="rtl"
      // Default aria-describedby to undefined so Radix doesn't fire its
      // "Missing Description or aria-describedby" warning on every
      // dialog that intentionally has no body description. Consumers
      // that DO provide an id win via the {...props} spread below — the
      // explicit prop only acts as a no-description opt-out otherwise.
